...
class OnlineTest extends JFrame implements ActionListener
{
	...
	void set()
	{
		...
		if(current==4)
		{
			l.setText("Que5: Who is Developer of Java");
			jb[0].setText("Dennis Ritchie");jb[1].setText("James Gosling");jb[2].setText("Bjarne Stroustrup");jb[3].setText("Guido van Rossum");
		}
		if(current==5)
		{
